...
class OrderController extends Controller
{
    public function index(Request $request)
    {
        $orders = [
            ...
            [
                ...
                'product_name' => 'Kemeja Tactical PDL Japan Drill',
    ...
    public function show($id)
    {
        $order = [
            ...
            'design_file' => 'https://via.placeholder.com/600x400.png?text=Mockup+Desain+Sinergi.pdf',
        ];
    ...
    public function invoice($id)
    {
        $order = [
            ...
            'email' => 'ahmad.fauzi@sinergi.co.id',
            'shipping_address' => 'Jl. Asia Afrika No. 120, Gedung Wisma Sinergi Lt. 4, Bandung, Jawa Barat 40112',
            'product_name' => 'Jaket Coach Taslan Waterproof Custom',
            'color' => 'Navy Blue',
            'quantity' => 50,
            'unit_price' => 185000,
            'subtotal' => 9250000,
