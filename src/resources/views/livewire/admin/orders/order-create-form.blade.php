<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="pb-5 border-b border-[#E2E5E9]">
        <h1 class="text-2xl sm:text-3xl font-bold text-[#102A43] tracking-tight">Tambah Pesanan Manual</h1>
    ...
    <form id="order-create-form" wire:submit="save" class="space-y-6">
        ...
        <div class="admin-card p-5 sm:p-6 space-y-4">
            <div class="border-b border-[#E2E5E9] pb-3">
                <h2 class="text-sm sm:text-base font-semibold text-[#102A43]">1. Data Pelanggan</h2>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label for="nama" class="block text-xs font-semibold text-[#102A43] mb-1.5">
                    ...
                    <input
                        ...
                        class="w-full px-3.5 py-2.5 bg-white border border-[#D0D5DD] focus:border-[#102A43] text-xs sm:text-sm text-[#102A43] rounded-lg focus:outline-none"
                    />
                    @error('nama')
                ...
                <div>
                    <label for="no_hp" class="block text-xs font-semibold text-[#102A43] mb-1.5">
                    ...
                    <input
                        ...
                        class="w-full px-3.5 py-2.5 bg-white border border-[#D0D5DD] focus:border-[#102A43] text-xs sm:text-sm text-[#102A43] rounded-lg focus:outline-none font-mono"
                    />
                    @error('no_hp')
                        <p class="text-xs text-rose-600 mt-1 font-medium">{{ $message }}</p>
                    @enderror
                ...
                <div class="sm:col-span-2">
                    <label for="alamat" class="block text-xs font-semibold text-[#102A43] mb-1.5">
        ...
        <div class="admin-card p-5 sm:p-6 space-y-4">
            <div class="border-b border-[#E2E5E9] pb-3">
                <h2 class="text-sm sm:text-base font-semibold text-[#102A43]">2. Produk &amp; Bahan Kain</h2>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="block text-xs font-semibold text-[#102A43] mb-2">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
                        @foreach ($materials as $m)
                            <label class="flex items-center gap-2 p-2 border border-[#E2E5E9] rounded-lg hover:bg-[#F7F7F5] cursor-pointer text-xs transition-colors">
                                ...
                                />
                                <span class="truncate text-[#102A43]">{{ $m->nama_bahan }}</span>
                            </label>
                        @endforeach
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                            @foreach ($sizes as $s)
                                <div class="p-3 border border-[#E2E5E9] rounded-lg bg-[#F7F7F5] flex flex-col items-center justify-center space-y-1.5 text-center">
                                    <span class="text-xs font-bold text-[#102A43] block tracking-wide">{{ $s->nama_ukuran }}</span>
                                    <input
                                        type="number"
                                        min="0"
                                        wire:model="ukuran.{{ $s->id_ukuran }}"
                                        placeholder="0"
                                        class="w-full px-2 py-1.5 bg-white border border-[#D0D5DD] focus:border-[#102A43] focus:ring-1 focus:ring-[#102A43]/20 rounded text-xs text-center font-mono font-semibold text-[#102A43] focus:outline-none transition-colors"
                                    />
                                </div>
                            @endforeach
                        </div>
        ...
        <div class="admin-card p-5 sm:p-6 space-y-4">
            <div class="border-b border-[#E2E5E9] pb-3">
                <h2 class="text-sm sm:text-base font-semibold text-[#102A43]">3. Penetapan Harga &amp; Catatan</h2>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="w-full pl-9 pr-3.5 py-2.5 bg-white border border-[#D0D5DD] focus:border-[#102A43] font-mono text-xs sm:text-sm text-[#102A43] rounded-lg focus:outline-none"
                        />
                    </div>
                ...
                <div class="sm:col-span-2">
                    <label for="notes" class="block text-xs font-semibold text-[#102A43] mb-1.5">
