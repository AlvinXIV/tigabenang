@if (session('success') || session('status'))
    <div
        ...
        class="mb-6 bg-emerald-50 border border-emerald-200 rounded-2xl p-4 flex items-start justify-between shadow-xs"
    >
        <div class="flex items-center gap-3">
            ...
            <div>
                <h4 class="text-xs font-bold text-emerald-900 uppercase tracking-wide">Berhasil</h4>
...
@if (session('error') || $errors->any())
    <div
        ...
        x-transition:enter-start="opacity-0 translate-y-2"
        x-transition:enter-end="opacity-100 translate-y-0"
        class="mb-6 bg-rose-50 border border-rose-200 rounded-2xl p-4 flex items-start justify-between shadow-xs"
    >
        <div class="flex items-start gap-3">
            ...
            <div>
                <h4 class="text-xs font-bold text-rose-900 uppercase tracking-wide">Perhatian</h4>
                @if (session('error'))
