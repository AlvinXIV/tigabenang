...
<div class="rounded-xl border border-dashed border-[#E2E5E9] bg-white px-6 py-12 text-center">
    <div class="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-[#EBF1F7]">
        <svg class="h-5 w-5 text-[#102A43]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
