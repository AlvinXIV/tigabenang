...
>
    <button
        ...
        aria-label="{{ $label }}"
        title="{{ $label }}"
        class="inline-flex items-center justify-center w-8 h-8 rounded-lg text-[#667085] hover:text-[#102A43] hover:bg-[#F7F7F5] active:bg-[#EEEFEC] focus:outline-none focus:ring-2 focus:ring-[#102A43]/20 transition-colors cursor-pointer border-0 bg-transparent"
    >
