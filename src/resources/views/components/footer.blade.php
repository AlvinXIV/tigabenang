            ...
            <div>
                ...
                @if ($whatsappHref)
                    <a
                        ...
                        class="mt-5 inline-flex items-center gap-2 rounded-[8px] bg-[#F7F7F5] px-4 py-2.5 text-sm font-semibold text-[#102A43] no-underline shadow-sm transition-colors duration-150 hover:bg-white"
                    >
